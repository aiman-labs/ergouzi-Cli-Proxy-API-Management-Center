        ...
        <FieldGrid>
          ...
          <FieldAnchor fieldId="routingCodexProPlanPriority">
            <Input
              ...
              onChange={(event) => onChange({ routingCodexProPlanPriority: event.target.value })}
              disabled={disabled}
          ...
          <FieldAnchor fieldId="routingCodexPlusPlanPriority">
            <Input
              ...
              onChange={(event) => onChange({ routingCodexPlusPlanPriority: event.target.value })}
              disabled={disabled}
              hint={t('config_management.visual.sections.network.codex_plan_priority_hint')}
          ...
          <FieldAnchor fieldId="routingCodexTeamPlanPriority">
            <Input
              ...
              onChange={(event) => onChange({ routingCodexTeamPlanPriority: event.target.value })}
              disabled={disabled}
              hint={t('config_management.visual.sections.network.codex_plan_priority_hint')}
