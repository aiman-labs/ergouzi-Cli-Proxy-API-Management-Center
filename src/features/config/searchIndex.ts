...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  {
    fieldId: 'routingCodexProPlanPriority',
    sectionId: 'network',
    labelKey: L('sections.network.codex_plan_priority'),
    hintKey: L('sections.network.codex_plan_priority_hint'),
    yamlKeys: ['routing', 'codex-plan-priorities', 'pro'],
    keywords: ['codex', 'pro', 'priority'],
  },
  {
    fieldId: 'routingCodexPlusPlanPriority',
    sectionId: 'network',
    labelKey: L('sections.network.codex_plan_priority'),
    hintKey: L('sections.network.codex_plan_priority_hint'),
    yamlKeys: ['routing', 'codex-plan-priorities', 'plus'],
    keywords: ['codex', 'plus', 'priority'],
  },
  {
    fieldId: 'routingCodexTeamPlanPriority',
    sectionId: 'network',
    labelKey: L('sections.network.codex_plan_priority'),
    hintKey: L('sections.network.codex_plan_priority_hint'),
    yamlKeys: ['routing', 'codex-plan-priorities', 'team'],
    keywords: ['codex', 'team', 'priority'],
  },
  {
  ...
  {
    fieldId: 'quotaAutoDisableEnabled',
    sectionId: 'quota',
    labelKey: L('sections.quota.auto_disable_enabled'),
    hintKey: L('sections.quota.auto_disable_enabled_desc'),
    yamlKeys: ['quota-auto-disable', 'enabled'],
  },
  {
    fieldId: 'quotaAutoDisableAutoEnable',
    sectionId: 'quota',
    labelKey: L('sections.quota.auto_enable'),
    hintKey: L('sections.quota.auto_enable_desc'),
    yamlKeys: ['quota-auto-disable', 'auto-enable'],
  },
  {
    fieldId: 'quotaAutoDisableScanIntervalSeconds',
    sectionId: 'quota',
    labelKey: L('sections.quota.scan_interval'),
    hintKey: L('sections.quota.scan_interval_hint'),
    yamlKeys: ['quota-auto-disable', 'scan-interval-seconds'],
  },
  {
    fieldId: 'quotaAutoDisableScanConcurrency',
    sectionId: 'quota',
    labelKey: L('sections.quota.scan_concurrency'),
    hintKey: L('sections.quota.scan_concurrency_hint'),
    yamlKeys: ['quota-auto-disable', 'scan-concurrency'],
  },
  {
    fieldId: 'quotaAutoDisableScanRateLimitPerSecond',
    sectionId: 'quota',
    labelKey: L('sections.quota.scan_rate_limit'),
    hintKey: L('sections.quota.scan_rate_limit_hint'),
    yamlKeys: ['quota-auto-disable', 'scan-rate-limit-per-second'],
  },
  {
    fieldId: 'quotaAutoDisableProbeTimeoutSeconds',
    sectionId: 'quota',
    labelKey: L('sections.quota.probe_timeout'),
    hintKey: L('sections.quota.probe_timeout_hint'),
    yamlKeys: ['quota-auto-disable', 'probe-timeout-seconds'],
  },
  {
    fieldId: 'quotaAutoDisableMinCapacityCoveragePercent',
    sectionId: 'quota',
    labelKey: L('sections.quota.min_capacity_coverage'),
    hintKey: L('sections.quota.min_capacity_coverage_hint'),
    yamlKeys: ['quota-auto-disable', 'min-capacity-coverage-percent'],
  },
  {
    fieldId: 'quotaAutoDisableProPlanEnabled',
    sectionId: 'quota',
    labelKey: L('sections.quota.pro_plan_enabled'),
    yamlKeys: ['quota-auto-disable', 'plan-policies', 'pro', 'enabled'],
  },
  {
    fieldId: 'quotaAutoDisableProPlanThresholdPercent',
    sectionId: 'quota',
    labelKey: L('sections.quota.plan_disable_threshold'),
    yamlKeys: ['quota-auto-disable', 'plan-policies', 'pro', 'threshold-percent'],
    keywords: ['pro'],
  },
  {
    fieldId: 'quotaAutoDisableProPlanResumeThresholdPercent',
    sectionId: 'quota',
    labelKey: L('sections.quota.plan_resume_threshold'),
    yamlKeys: ['quota-auto-disable', 'plan-policies', 'pro', 'resume-threshold-percent'],
    keywords: ['pro'],
  },
  {
    fieldId: 'quotaAutoDisablePlusPlanEnabled',
    sectionId: 'quota',
    labelKey: L('sections.quota.plus_plan_enabled'),
    yamlKeys: ['quota-auto-disable', 'plan-policies', 'plus', 'enabled'],
  },
  {
    fieldId: 'quotaAutoDisablePlusPlanThresholdPercent',
    sectionId: 'quota',
    labelKey: L('sections.quota.plan_disable_threshold'),
    yamlKeys: ['quota-auto-disable', 'plan-policies', 'plus', 'threshold-percent'],
    keywords: ['plus'],
  },
  {
    fieldId: 'quotaAutoDisablePlusPlanResumeThresholdPercent',
    sectionId: 'quota',
    labelKey: L('sections.quota.plan_resume_threshold'),
    yamlKeys: ['quota-auto-disable', 'plan-policies', 'plus', 'resume-threshold-percent'],
    keywords: ['plus'],
  },
  {
    fieldId: 'quotaAutoDisableTeamPlanEnabled',
    sectionId: 'quota',
    labelKey: L('sections.quota.team_plan_enabled'),
    hintKey: L('sections.quota.team_plan_enabled_desc'),
    yamlKeys: ['quota-auto-disable', 'plan-policies', 'team', 'enabled'],
  },
  {
    fieldId: 'quotaAutoDisableTeamPlanThresholdPercent',
    sectionId: 'quota',
    labelKey: L('sections.quota.plan_disable_threshold'),
    yamlKeys: ['quota-auto-disable', 'plan-policies', 'team', 'threshold-percent'],
    keywords: ['team', 'k12'],
  },
  {
    fieldId: 'quotaAutoDisableTeamPlanResumeThresholdPercent',
    sectionId: 'quota',
    labelKey: L('sections.quota.plan_resume_threshold'),
    yamlKeys: ['quota-auto-disable', 'plan-policies', 'team', 'resume-threshold-percent'],
    keywords: ['team', 'k12'],
  },
  {
  ...
  },
  {
    ...
    hintKey: L('sections.quota.capacity_alerts_enabled_desc'),
    yamlKeys: ['quota-capacity', 'alerts-enabled'],
  },
  {
    fieldId: 'quotaCapacitySnapshotsIncluded',
    sectionId: 'quota',
    labelKey: L('sections.quota.capacity_snapshots_included'),
    hintKey: L('sections.quota.capacity_snapshots_included_desc'),
    yamlKeys: ['quota-capacity', 'include-snapshots'],
  },
  {
    fieldId: 'quotaCapacityProFiveHourThreshold',
    sectionId: 'quota',
    labelKey: L('sections.quota.capacity_pro_five_hour_threshold'),
    hintKey: L('sections.quota.capacity_threshold_hint'),
    yamlKeys: ['quota-capacity', 'pro', 'five-hour-threshold'],
  },
  {
    fieldId: 'quotaCapacityProWeeklyThreshold',
    sectionId: 'quota',
    labelKey: L('sections.quota.capacity_pro_weekly_threshold'),
    hintKey: L('sections.quota.capacity_threshold_hint'),
    yamlKeys: ['quota-capacity', 'pro', 'weekly-threshold'],
  },
  {
    fieldId: 'quotaCapacityPlusFiveHourThreshold',
    sectionId: 'quota',
    labelKey: L('sections.quota.capacity_plus_five_hour_threshold'),
    hintKey: L('sections.quota.capacity_threshold_hint'),
    yamlKeys: ['quota-capacity', 'plus', 'five-hour-threshold'],
  },
  {
    fieldId: 'quotaCapacityPlusWeeklyThreshold',
    sectionId: 'quota',
    labelKey: L('sections.quota.capacity_plus_weekly_threshold'),
    hintKey: L('sections.quota.capacity_threshold_hint'),
    yamlKeys: ['quota-capacity', 'plus', 'weekly-threshold'],
  },
  {
    fieldId: 'quotaCapacityTeamFiveHourThreshold',
    sectionId: 'quota',
    labelKey: L('sections.quota.capacity_team_five_hour_threshold'),
    hintKey: L('sections.quota.capacity_threshold_hint'),
    yamlKeys: ['quota-capacity', 'team', 'five-hour-threshold'],
  },
  {
    fieldId: 'quotaCapacityTeamWeeklyThreshold',
    sectionId: 'quota',
    labelKey: L('sections.quota.capacity_team_weekly_threshold'),
    hintKey: L('sections.quota.capacity_threshold_hint'),
    yamlKeys: ['quota-capacity', 'team', 'weekly-threshold'],
  },
  // ── streaming ─────────────────────────────────────────────────────────────
  {
