...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  },
  {
    ...
    keywords: ['whole pool scan interval', 'codex quota'],
  },
  {
    ...
    keywords: ['whole pool scan concurrency', 'parallel codex quota scan'],
  },
  {
    ...
    keywords: ['whole pool scan rate limit', 'requests per second', 'unlimited scan'],
  },
  {
