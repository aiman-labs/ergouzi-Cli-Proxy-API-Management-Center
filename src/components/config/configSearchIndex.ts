...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  },
  {
    ...
    keywords: ['codex pro priority', 'plan priority'],
  },
  {
    ...
    keywords: ['codex plus priority', 'plan priority'],
  },
  {
    ...
    keywords: ['codex team priority', 'k12 team priority', 'plan priority'],
  },
  {
  ...
  },
  {
    ...
    keywords: ['auto disable', 'codex quota'],
  },
  {
    fieldId: 'quotaAutoDisableIntervalSeconds',
    sectionId: 'quota',
    labelKey: L('sections.quota.auto_disable_interval'),
    hintKey: L('sections.quota.auto_disable_interval_hint'),
    yamlKeys: ['quota-auto-disable', 'interval-seconds'],
    keywords: ['auto disable interval', 'codex quota'],
  },
  {
    fieldId: 'quotaAutoDisableMaxScanPerRun',
    sectionId: 'quota',
    labelKey: L('sections.quota.max_scan_per_run'),
    hintKey: L('sections.quota.max_scan_per_run_hint'),
    yamlKeys: ['quota-auto-disable', 'max-scan-per-run'],
  ...
  },
  {
    ...
    keywords: ['probe timeout', 'codex quota timeout'],
  },
  {
    fieldId: 'quotaAutoDisableSampleFreshnessSeconds',
    sectionId: 'quota',
    labelKey: L('sections.quota.sample_freshness'),
    hintKey: L('sections.quota.sample_freshness_hint'),
    yamlKeys: ['quota-auto-disable', 'sample-freshness-seconds'],
    keywords: ['sample freshness', 'rolling quota sample'],
  },
  {
    fieldId: 'quotaAutoDisableAccountErrorBackoffSeconds',
    sectionId: 'quota',
    labelKey: L('sections.quota.account_error_backoff'),
    hintKey: L('sections.quota.account_error_backoff_hint'),
    yamlKeys: ['quota-auto-disable', 'account-error-backoff-seconds'],
    keywords: ['account error backoff', 'token revoked backoff'],
  },
  {
    fieldId: 'quotaAutoDisableTransientErrorBackoffSeconds',
    sectionId: 'quota',
    labelKey: L('sections.quota.transient_error_backoff'),
    hintKey: L('sections.quota.transient_error_backoff_hint'),
    yamlKeys: ['quota-auto-disable', 'transient-error-backoff-seconds'],
    keywords: ['transient error backoff', 'temporary failure backoff'],
  },
  {
    ...
    keywords: ['capacity coverage', 'suppressed capacity alert'],
  },
  {
    ...
    yamlKeys: ['quota-auto-disable', 'capacity-alerts', 'enabled'],
    keywords: ['capacity alert', 'codex quota capacity', 'capacity patrol'],
  },
  {
  ...
  },
  {
    ...
    keywords: ['pro 5 hour capacity', 'codex pro capacity alert'],
  },
  {
    ...
    keywords: ['pro weekly capacity', 'codex pro weekly alert'],
  },
  {
    ...
    keywords: ['plus 5 hour capacity', 'codex plus capacity alert'],
  },
  {
    ...
    keywords: ['plus weekly capacity', 'codex plus weekly alert'],
  },
  {
