...
export const providersApi = {
  ...
  updateMetaConfig: (apiKey: string, baseUrl: string | undefined, config: ProviderKeyConfig, index: number) =>
    mutateLatestProviderList('meta-api-key', (latestItems) =>
      replaceLatestProviderRecord(
        latestItems,
        (record, currentIndex) => matchesProviderKeyAtIndex(record, currentIndex, apiKey, baseUrl, index),
        serializeProviderKey(config),
